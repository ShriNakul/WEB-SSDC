      ...
      <div className={styles.heroContainer}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.brandHeading}>
            <span>SSDC</span>
            <svg className={styles.brandIcon} viewBox="0 0 16 16">
              <path d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5 0 0 0 14.367 7z" />
            </svg>
          </div>

          <h1 className={styles.heroDescription}>
            Solid State Drive Cleaner (SSDC) is the ultimate app to clean your
            storage.
          </h1>

          {/* Action Buttons */}
          <div className={styles.buttonGroup}>
            <Link to="/installation" className={styles.btnPrimary}>
          ...
          <div className={styles.platformIconsRow}>
            ...
            {/* Browser Icons: Chrome, Brave, Firefox */}
            <div className={styles.browserGroup}>
              ...
              {/* Brave (Retained from previous since it wasn't provided in the strict override list) */}
              <svg
                className={styles.platformIcon}
                viewBox="0 0 24 24"
                title="Brave"
              >
                <path d="M12 1L3 5v6c0 6.63 4.97 11.58 9 12 4.03-.42 9-5.37 9-12V5l-9-4zm0 2.18l7 3.11v4.71c0 5.17-3.83 9.07-7 9.47-3.17-.4-7-4.3-7-9.47V6.29l7-3.11z" />
              </svg>
        ...
        {/* Right Column: Animated Monitor Graphic */}
        <div className={styles.mediaWrapper}>
          <div className={styles.monitorContainer}>
            <div className={styles.screen}>
              <div className={styles.screenDriveText}>OS (C:)</div>
              <div className={styles.progressBarTrack}>
                <div className={styles.progressBarFill} />
              </div>
            </div>
            <div className={styles.standStem} />
